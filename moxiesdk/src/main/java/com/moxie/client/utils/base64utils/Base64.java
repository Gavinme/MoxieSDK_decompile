 ...
 * <br />
 * <code>byte[] myByteArray = Base64.encode( encoded );</code>
 * <p>
 ...
 * byte[] using <tt>encode( String s, boolean gzipCompressed )</tt>.
...
//        }
    ...
    public static byte[] decode(byte[] source, int off, int len, int options)
        ...
        // Lots of error checking and exception throwing
        if (source == null) {
            throw new NullPointerException("Cannot encode null source array.");
        }   // end if
    ...
    /**
     * Attempts to encode Base64 data and deserialize a Java
     * Object within. Returns <tt>null</tt> if there was an error.
     *
     * @param encodedObject The Base64 data to encode
     ...
     * and encode/encode to/from Base64 notation on the fly.
     *
     * @see Base64
     * @since 1.3
     */
