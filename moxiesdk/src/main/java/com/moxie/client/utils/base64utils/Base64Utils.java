...
package com.moxie.client.utils.base64utils;
 ...
 * class delegates to android.util.Base64 . If the version is older than
...
public class Base64Utils {
     ...
     * Otherwise {@link com.baidu.paysdk.utils.support.Base64#encodeBytesToBytes(byte[])}
     * is used.
     *
     * @param input the byte array to encode
     * @return encoded byte array
     */
    public static byte[] encode(byte[] input) { // NO_UCD (unused code)
        if (froyoOrNewer) {
     ...
     * Otherwise {@link com.baidu.paysdk.utils.support.Base64#encodeBytes(byte[])}
     * is used.
     *
     * @param input the byte array to encode
     ...
     * Otherwise {@link com.baidu.paysdk.utils.support.Base64#decode(byte[])}
     * is used.
     *
     * @param input the byte array to encode
     * @return decoded byte array
     */
    public static byte[] decode(byte[] input) { // NO_UCD (unused code)
        if (froyoOrNewer) {
     ...
     * Otherwise {@link com.baidu.paysdk.utils.support.Base64#decode(String)}
     * is used.
     *
     * @param str the String the encode
     * @return decoded byte array
     */
    public static byte[] decode(String str) { // NO_UCD (unused code)
        if (froyoOrNewer) {
