package com.moxie.client.widget.LoadingDialog.components;
...
public class FlowerDataCalc {
    ...
    public final List<PetalCoordinate> a(int i, int i2, int i3, int i4, int i5) {
        List<PetalCoordinate> arrayList = new ArrayList(i4);
        double d = ((double) i) / 2.0d;
        double d2 = ((double) i5) / 2.0d;
        double d3 = ((double) (i - i2)) / 2.0d;
        double d4 = ((double) i3) / 2.0d;
        for (int i6 = 0; i6 < i4; i6++) {
            arrayList.add(new PetalCoordinate((int) (d2 - (this.a[i6] * d3)), (int) ((this.b[i6] * d3) + d), (int) (d2 - (this.a[i6] * d4)), (int) ((this.b[i6] * d4) + d)));
        }
        return arrayList;
    }
