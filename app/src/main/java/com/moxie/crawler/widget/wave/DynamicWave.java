...
/**
 * Created by taoweisong on 16/8/2.
 */
public class DynamicWave extends View {

    // 波纹颜色
    private static final int WAVE_PAINT_COLOR = 0xffff9500;
    // y = Asin(wx+url)+responseId
    ...
    public DynamicWave(Context context, AttributeSet attrs) {
        ...
        waveHeight =  (UiUtils.getScreenDensityDpi(context) / 240 * 200);
    }
